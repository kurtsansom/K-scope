...
public class LanguageVisitor implements ILanguageEntry {
  ...
  /**
   * Check if the subroutine or function is included in the recursive call list. If it is not
   * included in the recursive call list, add it to the recursive call list.
   *
