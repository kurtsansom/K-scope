...
/**
 * Additional information retrieval class. Get all additional information under the specified block.
 *
 * @author RIKEN
 */
public class InformationEntry implements ILanguageEntry {
  ...
  /**
   * Get additional information. Get additional information that matches the start block from the
